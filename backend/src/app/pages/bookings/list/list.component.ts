...
export class BookingsListComponent implements OnInit {
  ...
  constructor(
    ...
    this.bookingsStoreSubscription = this.store
      ...
      .subscribe(state => {
        ...
        this.bookings = [...state.bookings_open, ...state.bookings_closed]
        this.stati = state.stati
  ...
  dettagli() {
    return this.aclService.checkUserRole(APP_ROUTING_ACL['prenotazione-sala/index'])
  }
  ...
  search(): any[] {
    this.loading = true
    let roomBookingsInPage = Object.assign([], this.bookings)
