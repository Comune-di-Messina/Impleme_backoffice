...
import { RoomsCategoriesService, RoomsTypologiesService } from 'src/app/services/api'
import { Location } from '@angular/common'

@Component({
  selector: 'struttura-categoria-create',
...
export class CreateComponent implements OnInit {
  ...
  saveModel() {
    ...
    this.roomsCategoriesService.create(model).subscribe(
      data => {
        this.location.back()
      },
      error => {
