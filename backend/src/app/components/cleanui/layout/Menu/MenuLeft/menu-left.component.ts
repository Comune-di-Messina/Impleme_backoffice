...
import { existInUserRole } from 'src/app/store'
...
export class MenuLeftComponent implements OnInit {
  ...
  constructor(private menuService: MenuService, private store: Store<any>, private router: Router, private aclService: ACLService) {
  ...
  checkUserRoleInMenuRoles(menuRoles)
  {
    return this.aclService.checkUserRole(menuRoles);
  }
